      ...
      >
       ...
       <div className='rounded-full  border-4 border-[#AD8E63] '>
                    ...
                    <div className='flex flex-col justify-center md:items-start items-center'>
                        <div className='flex gap-2  justify-center items-center pt-4 sm:pt-6'>
                  <h2 className="text-[#0F4082] font-bold  text-[18px] sm:text-[20px] md:text-[24px]">{SelectedCard.name} </h2>
             <Link href={SelectedCard.linkedin} target='_blank' rel='noopener noreferrer'><Image src='/linkedinbl.svg' width={24} height={24} alt='linkedin'/></Link>
                  </div>
